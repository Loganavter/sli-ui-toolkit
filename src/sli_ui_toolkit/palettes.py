...
FLUENT_LIGHT = {
    ...
    "titlebar.background": QColor("#f5f5f5"),
    "titlebar.text": QColor("#1f1f1f"),
    "titlebar.menu.hover": QColor("#e8e8e8"),
...
FLUENT_DARK = {
    ...
    "toast.progress.background": QColor("#40FFFFFF"),
    "toast.progress.fill": QColor("#0096FF"),
    ...
    "titlebar.background": QColor("#2b2b2b"),
    "titlebar.text": QColor("#dfdfdf"),
    "titlebar.menu.hover": QColor("#3a3a3a"),
